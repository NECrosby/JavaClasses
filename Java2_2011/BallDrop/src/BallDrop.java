...
//let the user input the number of balls that will be droped
// possible ways of doing that.. inputbox, textbox with button(either way need to add validation code..min number of balls in 1 play with new panel to decide mas number of balls
...
//don't over think this the program works you are just adding and modifing this one
...
public class BallDrop extends JFrame { 
